...
- `skills/init/scaffold/CLAUDE_TRACK_SECTION.md` — rendered CLAUDE.md section appended to adopting repos
- `tools/render-track-protocol.sh` — regenerates the shared Track protocol surfaces
