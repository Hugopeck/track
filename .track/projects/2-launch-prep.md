...
## Shared Context
See `.track/plans/launch-1000-users.md` for the full strategy. This project covers Phase 0 of that plan.

## Dependency Notes
Must complete before projects 4 and 5 can begin effectively.

## Success Definition
A cold visitor to the GitHub repo understands what Track is, why it matters, and can install it in 60 seconds.
